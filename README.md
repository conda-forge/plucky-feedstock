...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/plucky-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15461&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/plucky-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `plucky` can be installed with:

```
conda install plucky
```

It is possible to list all of the versions of `plucky` available on your platform with:
